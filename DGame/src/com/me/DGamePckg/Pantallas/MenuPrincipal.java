package com.me.DGamePckg.Pantallas;
...
public class MenuPrincipal extends Pantalla {
    ...
    public MenuPrincipal(DGameClass juego) {
        this.juego = juego;
    ...
    public void resize(int width, int height) {} //sirve para recalcular el tamaño de los elementos cuando se modifica la pantalla

    public void pause() {}	/*, y resume() y pause(), que son funciones que se ejecutan en Android cuando salimos de la aplicación o se interrumpe la ejecución de la misma y volvemos a ella.*/
